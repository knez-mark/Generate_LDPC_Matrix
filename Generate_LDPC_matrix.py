...
n = 192  # number of columns, corresponds to codeword length
p = 3  # column weight
q = 8  # row weight
...
# can take a while...
[bestH, g] = get_best_matrix(newH, 100, verbose=True)
...
print("\tRank :", np.linalg.matrix_rank(bestH))
